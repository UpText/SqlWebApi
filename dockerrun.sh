...
docker run  --platform linux/amd64 -p 8081:80 \
...
-e SQLWEBAPI__SQLSCHEMA=api \
-e SQLWEBAPI__SQLCONNECTIONSTRING="Server=host.docker.internal,1433;Initial Catalog=NorthWind;Persist Security Info=False;User ID=UpTextService;Password=UpService123;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=True;Connection Timeout=30;" \
--name SqlWebApi --rm swa:debug 
